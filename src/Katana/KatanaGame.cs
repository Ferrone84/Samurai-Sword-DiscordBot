	...
	public class KatanaGame : IGame<KatanaGameInstance> {
		private ConcurrentDictionary<string, KatanaPlayingCardModel> playing_cards = new ConcurrentDictionary<string, KatanaPlayingCardModel>(
			new Dictionary<string, KatanaPlayingCardModel>() {
				/* Weapons */
				{"bokken"     , new Weapon("Bokken"     , "bokken"     , 1, 1)},
				{"bo"         , new Weapon("Bo"         , "bo"         , 2, 1)},
				{"daikyu"     , new Weapon("Daikyu"     , "daikyu"     , 5, 2)},
				{"kanabo"     , new Weapon("Kanabo"     , "kanabo"     , 3, 2)},
				{"katana"     , new Weapon("Katana"     , "katana"     , 2, 3)},
				{"kiseru"     , new Weapon("Kiseru"     , "kiseru"     , 1, 2)},
				{"kusarigama" , new Weapon("Kusarigama" , "kusarigama" , 2, 2)},
				{"nagayari"   , new Weapon("Nagayari"   , "nagayari"   , 4, 2)},
				{"naginata"   , new Weapon("Naginata"   , "naginata"   , 4, 1)},
				{"nodachi"    , new Weapon("Nodachi"    , "nodachi"    , 3, 3)},
				{"shuriken"   , new Weapon("Shuriken"   , "shuriken"   , 3, 1)},
				{"tanegashima", new Weapon("Tanegashima", "tanegashima", 5, 1)},
				{"wakizashi"  , new Weapon("Wakizashi"  , "wakizashi"  , 1, 3)},
				/* Actions */
				{"tea-ceremony", new Action("Cérémonie du thé", "Piochez 3 cartes. Les autres joueurs piochent 1 carte.", "tea-ceremony")},
				{"bushido", new Action("Code du Bushido", "Si la carte est devant vous au début de votre tour, piochez une carte et défaussez-la. Si c'est une arme, défaussez une arme et passez ensuite la carte à votre voisin de gauche, sinon, passez la carte à votre voisin de gauche. Si vous devez défausser une arme mais n'en avez pas, vous perdez un point d'honneur et défaussez cette carte. Votre tour se déroule ensuite normalement.", "bushido")},
				{"battle-cry", new Action("Cri de guerre", "Les autres joueurs doivent défausser 1 parade ou perdre 1 point de vie.", "battle-cry")},
				{"daimyo", new Action("Daimyo", "Piochez 2 cartes. Si vous possédez cette carte à la fin de la partie et n'êtes pas Ronin, vous gagner 1 point d'honneur après l'application d'un éventuel mutliplicateur.", "daimyo")},
				{"diversion", new Action("Diversion", "Piochez au hasard 1 carte dans la main d'un joueur de votre choix et ajoutez-la à votre main.", "diversion")},
				{"geisha", new Action("Geisha", "Défaussez 1 carte permanente en jeu (hors Code du Bushido) ou 1 carte au hasard de la main d'un autre joueur.", "geisha")},
				{"jujitsu", new Action("Jujitsu", "Les autres joueurs doivent défausser 1 arme ou perdre 1 point de vie.", "jujitsu")},
				{"breathing", new Action("Méditation", "Récupérez tous vos points de vie. Un joueur de votre choix (autre que vous) pioche 1 carte.", "breathing")},
				{"parry", new Action("Parade", "Bloque une attaque causée par une arme.", "parry")},
				/* Properties */
